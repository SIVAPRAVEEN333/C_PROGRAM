/*
*
* @program: minimum elements of the array
...
int main()
{
    ...
    for(int i=0;i<array_element_count;i++)
    {
        ...
        {
            array_element_min=array_element_value[i];
            array_element_value[i]=array_element_value[i+1];
            array_element_value[i+1]=array_element_min;
        }
    }
    printf("\nThe minimum elements in the array: %d",array_element_min);
}
